...
[#-- @ftlvariable name="consents" type="java.util.Map<java.util.UUID, java.util.List<java.lang.String>>" --]
      ...
      <div class="${colClass}">
        <div class="panel min-w-full" data-in-progress>        
          <div class="brand-logo-wrap" aria-hidden="true">
            <svg class="brand-logo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1207.31 362" focusable="false">
              <g>
                <path d="M396.27,235.53c-10.93,10.6-25.07,15.9-40.72,15.9-18.31,0-39.5-7.54-43.45-30.88h117.78c1.08-8.98,1.44-15.8,1.44-21.54,0-57.09-37.34-85.46-79-85.46s-86.9,30.88-86.9,89.77,44.53,88.33,89.77,88.33c29.8,0,56.37-12.21,74.69-35.19h-.01s-33.59-20.93-33.59-20.93ZM350.88,152.33c20.11,0,34.83,11.85,36.98,33.39h-75.76c2.87-19.39,16.88-33.39,38.78-33.39M28.1,38.6c15.54,0,28.76,12.89,28.76,28.43s-13.22,28.1-28.76,28.1S0,82.24,0,67.04s12.89-28.43,28.1-28.43M5.45,117.85h45.96v170.2H5.45V117.85ZM251.1,151.31l-63.66,136.74h-42.73l-63.74-136.77v-33.43h37.59l47.7,110.24,47.27-110.24h37.58v33.46h0Z"/>
                <path d="M1042.12,162.23c-18.24,0-30.61,11.13-34.01,29.06h63.69c0-16.39-10.2-29.06-29.68-29.06Z"/>
                <path d="M649.47,110.6c-38.03,0-65.55,29.37-65.55,69.57s27.52,69.57,65.55,69.57,65.24-29.37,65.24-69.57-27.21-69.57-65.24-69.57Z"/>
                <path d="M1026.31,0h-377c-99.96,0-181,81.04-181,181h0c0,99.96,81.04,181,181,181h377c99.96,0,181-81.04,181-181h0c0-99.96-81.04-181-181-181ZM649.47,293.33c-64,0-111.62-48.54-111.62-113.16s47.61-113.16,111.62-113.16,111.62,48.54,111.62,113.16-47.92,113.16-111.62,113.16ZM935.66,288.38h-44.52v-94.92c0-19.17-12.68-28.14-26.9-28.14-15.46,0-31.54,11.44-31.54,35.87v87.19h-44.52v-158.92h43.29v19.17c9.58-14.53,27.52-22.88,47.61-22.88,30.92,0,56.58,19.48,56.58,61.53v101.1ZM1116.02,223.14h-106.98c2.78,15.15,17.01,28.44,39.89,28.44,16.39,0,30.3-7.42,39.58-17.93l22.57,27.83c-17.62,18.55-39.58,28.76-66.78,28.76-49.78,0-81.32-34.01-81.32-81.01s32.46-83.48,82.24-83.48c44.83,0,70.8,29.06,70.8,80.7v16.7Z"/>
              </g>
            </svg>
          </div>
  ...
  <div class="${rowClass}">
    ...
    <div class="${colClass}" style="text-align: right;">
      ...
      <a href="${actionURL}"> <i class="fa fa-arrow-left"></i>
        ${actionTexts[url_index]}
      </a>
      [#else]
      <a class="d-inline-block mb-2" href="${actionURL}">
        ${actionTexts[url_index]}
  ...
  <button class="apple login-button" data-scope="${identityProvider.lookupScope(clientId)!''}"
    ...
    <div>
      ...
      <div class="text">
        ${identityProvider.lookupButtonText(clientId)?trim}
      </div>
    </div>
  </button>
  [/#macro]
  ...
  --]
  <div id="g_id_onload"
    [#list identityProvider.lookupAPIProperties(clientId)!{} as attribute, value]
  ...
  <div class="g_id_signin"
    [#list identityProvider.lookupButtonProperties(clientId)!{} as attribute, value]
    data-${attribute}="${value}"
    [/#list]
  ...
  <div id="login-button-container" class="login-button-container" data-federated-csrf="${federatedCSRFToken}">
    ...
    <div class="form-row push-less-top">
      ...
      <div class="magic login-button">
        <div>
          ...
          <div class="text">
            ${theme.message('passwordless-button-text')}
          </div>
        </div>
      </div>
      [/@link]
    ...
    <div class="form-row push-less-top">
      ...
      <div class="magic login-button">
        <div>
          ...
          <div class="text">
            ${theme.message('webauthn-button-text')}
          </div>
        </div>
      </div>
      [/@link]
    ...
    [#list identityProviders["EpicGames"]
    as identityProvider]
    <div class="form-row push-less-top">
    ...
    [/#if]
    [#if identityProviders["Facebook"]?has_content]
    [#list identityProviders["Facebook"]
    as identityProvider]
    <div class="form-row push-less-top">
    ...
    [#list identityProviders["LinkedIn"]
    as identityProvider]
    <div class="form-row push-less-top">
    ...
    [#list identityProviders["Nintendo"]
    as identityProvider]
    <div class="form-row push-less-top">
    ...
    [#list identityProviders["OpenIDConnect"]
    as identityProvider]
    <div class="form-row push-less-top">
    ...
    [#list identityProviders["SonyPSN"]
    as identityProvider]
    <div class="form-row push-less-top">
    ...
    [/#if]
    [#if identityProviders["Twitter"]?has_content]
    [#list identityProviders["Twitter"]
    as identityProvider]
    <div class="form-row push-less-top">
...
[#macro _input_checkbox name id value uncheckedValue label tooltip]
  ...
  <div class="form-row">
    ...
    <div id="${id}" class="${class}">
      ...
      [/#if]
      <label class="radio"><input type="radio" name="${name}" value="${option}"
          [#if checked]
          checked="checked"
          [/#if]><span
          class="box"></span><span class="label">
          ${theme.optionalMessage(option)}
        </span></label>
      [/#list]
    </div>
  ...
  <div class="form-row">
    ...
    <div id="${id}" class="${class}">
      ...
      [#local checked = consents(field.consentId)?? && consents(field.consentId)?contains(option)]
      [/#if]
      <label class="checkbox"><input type="checkbox" name="${name}" value="${option}"
          [#if checked]
          checked="checked"
          [/#if]><span
          class="box"></span><span class="label">
  ...
  <div class="form-row">
    ...
    <label class="select">
      <select name="${name}" id="${id}" class="${class}"
        ...
        [/#if]>
        <option value="">
          ${theme.optionalMessage("none-selected")}
        </option>
...
[/#macro]
  ...
  [/#local]
  <a
    href="/oauth2/logout?tenantId=${(tenantId)!''}&client_id=${(client_id)!''}&post_logout_redirect_uri=${post_logout_redirect_uri?markup_string?url}">
    [#t]
    [#nested/]
    [#t]
  </a>
  ...
  <div class="form-row">
    <label for="editPasswordOption">
      ${theme.optionalMessage("change-password")}
    </label>
  ...
  <div id="password-fields" class="slide-open ${(editPasswordOption == "update")?then('open', '')}">
    ...
    [#if field.confirm]
    [@customField field "confirm.${field.key}" false "[confirm]
    ${field.key}" /]
    [/#if]
  </div>
  [/#macro]
  ...
  [#local message = theme.optionalMessage("[{application}${application.id}]
  {scope-${messageType}}${scopeName}") /]
  [#local resolvedMessage = message != "[{application}${application.id}]
  {scope-${messageType}}${scopeName}" /]
  [#if !resolvedMessage]
  [#local message = theme.optionalMessage("[{tenant}${application.tenantId}]
  {scope-${messageType}}${scopeName}") /]
  [#local resolvedMessage = message != "[{tenant}${application.tenantId}]
  {scope-${messageType}}${scopeName}" /]
  [/#if]
  [#if !resolvedMessage]
